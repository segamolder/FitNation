<x-guest-layout>
    <section class="container relative flex px-6 py-16 mx-auto">
        <div class="relative z-20 flex flex-col sm:w-2/3 lg:w-2/5">
            ...
            <form class="flex mt-8" method="POST" action="{{ route('clients.save') }}">
                @csrf
        ...
        <div class="relative hidden sm:block sm:w-1/3 lg:w-3/5">
            <img src="{{ asset('/images/gym_room.jpg') }}"
                 class="max-h-[75%] max-w-xs m-auto md:max-w-sm border-4 border-pink-500"/>
        </div>
    </section>
    ...
    <section class="p-4 py-6">
        ...
        <div class="flex flex-col items-center space-y-24 md:space-y-0 md:flex-row justify-evenly">
            <div class="relative p-4">
                <div class="absolute mb-4 text-center transform translate-x-1/2 -top-16 right-1/2">
                    <a href="#" class="relative block">
                        <img alt="profil" src="{{ asset('images/coachers/coacher3.jpg') }}"
                ...
                <div class="px-8 py-4 pt-24 bg-white rounded-lg shadow dark:bg-gray-800">
                    <div class="text-center">
                        ...
                        <p class="py-4 mx-auto font-light text-gray-500 text-md w-60 dark:text-gray-400">
                            Елена - энергичный инструктор групповых тренировок, который создает веселую и мотивирующую
                            атмосферу на занятиях.
                        </p>
                    </div>
                    <div
                        class="flex items-center justify-between w-40 pt-8 mx-auto text-gray-500 border-t border-gray-200">
                        <a href="#">
            ...
            <div class="relative p-4">
                <div class="absolute mb-4 text-center transform translate-x-1/2 -top-16 right-1/2">
                    <a href="#" class="relative block">
                        <img alt="profil" src="{{ asset('images/coachers/coacher1.jpg') }}"
                             class="mx-auto object-cover rounded-lg h-40 w-40  border-2 border-white dark:border-gray-800"/>
                    </a>
                </div>
                <div class="px-8 py-4 pt-24 bg-white rounded-lg shadow dark:bg-gray-800">
            ...
            <div class="relative p-4">
                <div class="absolute mb-4 text-center transform translate-x-1/2 -top-16 right-1/2">
                    <a href="#" class="relative block">
                        <img alt="profil" src="{{ asset('images/coachers/coacher2.jpg') }}"
                             class="mx-auto object-cover rounded-lg h-40 w-40  border-2 border-white dark:border-gray-800"/>
                    </a>
                </div>
                <div class="px-8 py-4 pt-24 bg-white rounded-lg shadow dark:bg-gray-800">
                    <div class="text-center">
                        ...
                        <p class="py-4 mx-auto font-light text-gray-500 text-md w-60 dark:text-gray-400">
                            Михаил - тренер, специализирующийся на функциональном тренировочном подходе, который поможет
                            вам развить силу, выносливость и гибкость.
                        </p>
                    </div>
                    <div
                        class="flex items-center justify-between w-40 pt-8 mx-auto text-gray-500 border-t border-gray-200">
