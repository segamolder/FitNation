<x-guest-layout>
    <section class="container relative flex px-6 py-16 mx-auto">
        <div class="relative z-20 flex flex-col sm:w-2/3 lg:w-2/5">
            ...
            <p class="text-sm text-gray-700 sm:text-base dark:text-white">
                {{ __('Join FitNation and become the best version of yourself!') }}
            </p>
            <div class="flex mt-8">
                <div class="mr-4 text-white uppercase bg-pink-500 border-1 rounded-lg text-md">
                    <input type="text" id="rounded-email" class="rounded-lg flex-1 appearance-none w-full py-2 px-4 bg-white text-gray-700 placeholder-gray-400 shadow-sm text-base focus:outline-none focus:ring-2 focus:ring-purple-600 focus:border-transparent" placeholder="+7(999)999-99-99"/>
                </div>
        ...
        <div class="relative hidden sm:block sm:w-1/3 lg:w-3/5">
            <img src="{{ asset('/images/gym_room.jpg') }}" class="max-h-[75%] max-w-xs m-auto md:max-w-sm border-4 border-pink-500"/>
        </div>
    </section>

    <section class="flex-wrap items-center justify-center gap-8 text-center sm:flex bg-gray-100 pb-6">
        <div class="w-full px-4 py-4 mt-6 bg-white rounded-lg shadow-lg sm:w-1/2 md:w-1/2 lg:w-1/4 dark:bg-gray-800">
            ...
            <p class="py-4 text-gray-500 text-md dark:text-gray-300">
                {{ __('A program for children ages 5 to 12 that will help them develop a healthy lifestyle through games and fun exercises led by our professional trainers.') }}
            </p>
        </div>
        <div class="w-full px-4 py-4 mt-6 bg-white rounded-lg shadow-lg sm:w-1/2 md:w-1/2 lg:w-1/4 sm:mt-16 md:mt-20 lg:mt-24 dark:bg-gray-800">
            ...
            <p class="py-4 text-gray-500 text-md dark:text-gray-300">
                {{ __('A program that helps clients find training company and supports our clients in creating a circle of like-minded people who will support each other.') }}
            </p>
        </div>
        <div class="w-full px-4 py-4 mt-6 bg-white rounded-lg shadow-lg sm:w-1/2 md:w-1/2 lg:w-1/4 dark:bg-gray-800">
            <div class="flex-shrink-0">
            ...
            <h3 class="py-4 text-2xl font-semibold text-gray-700 sm:text-xl dark:text-white">
                {{ __('FitNation Wellness') }}
            </h3>
            <p class="py-4 text-gray-500 text-md dark:text-gray-300">
                {{ __('A program that helps clients develop an overall healthy lifestyle, including exercise, nutrition, rest and meditation. Clients receive personal counseling on all aspects of healthy living from our specialists.') }}
            </p>
        </div>
    </section>


    <section class="p-4 py-6">
        ...
        <p class="mb-32 text-xl font-normal text-center text-gray-500">
            {{ __('We are the best team in world') }}
        </p>
        <div class="flex flex-col items-center space-y-24 md:space-y-0 md:flex-row justify-evenly">
            <div class="relative p-4">
                <div class="absolute mb-4 text-center transform translate-x-1/2 -top-16 right-1/2">
                    <a href="#" class="relative block">
                        <img alt="profil" src="{{ asset('images/coachers/coacher3.jpg') }}" class="mx-auto object-cover rounded-lg h-40 w-40  border-2 border-white dark:border-gray-800"/>
                    </a>
                </div>
                <div class="px-8 py-4 pt-24 bg-white rounded-lg shadow dark:bg-gray-800">
                    <div class="text-center">
                        ...
                        <p class="text-xl font-light text-gray-500 dark:text-gray-200 w-60">
                            Инструктор групповых тренировок
                        </p>
                        <p class="py-4 mx-auto font-light text-gray-500 text-md w-60 dark:text-gray-400">
                            Елена - энергичный инструктор групповых тренировок, который создает веселую и мотивирующую атмосферу на занятиях.
                        </p>
                    </div>
            ...
            <div class="relative p-4">
                <div class="absolute mb-4 text-center transform translate-x-1/2 -top-16 right-1/2">
                    <a href="#" class="relative block">
                        <img alt="profil" src="{{ asset('images/coachers/coacher1.jpg') }}" class="mx-auto object-cover rounded-lg h-40 w-40  border-2 border-white dark:border-gray-800"/>
                    </a>
                </div>
                <div class="px-8 py-4 pt-24 bg-white rounded-lg shadow dark:bg-gray-800">
                    <div class="text-center">
                        ...
                        <p class="py-4 mx-auto font-light text-gray-500 text-md w-60 dark:text-gray-400">
                            Александр - опытный тренер, который поможет вам достичь ваших целей в кратчайшие сроки.
                        </p>
                    </div>
                    <div class="flex items-center justify-between w-40 pt-8 mx-auto text-gray-500 border-t border-gray-200">
                        <a href="#">
            ...
            <div class="relative p-4">
                <div class="absolute mb-4 text-center transform translate-x-1/2 -top-16 right-1/2">
                    <a href="#" class="relative block">
                        <img alt="profil" src="{{ asset('images/coachers/coacher2.jpg') }}" class="mx-auto object-cover rounded-lg h-40 w-40  border-2 border-white dark:border-gray-800"/>
                    </a>
                </div>
                <div class="px-8 py-4 pt-24 bg-white rounded-lg shadow dark:bg-gray-800">
                    <div class="text-center">
                        ...
                        <p class="py-4 mx-auto font-light text-gray-500 text-md w-60 dark:text-gray-400">
                            Михаил - тренер, специализирующийся на функциональном тренировочном подходе, который поможет вам развить силу, выносливость и гибкость.
                        </p>
                    </div>
                    <div class="flex items-center justify-between w-40 pt-8 mx-auto text-gray-500 border-t border-gray-200">
                        <a href="#">
